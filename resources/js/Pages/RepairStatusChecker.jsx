...
function RepairStatusChecker() {
    ...
    const repairData = {
        ...
        67890: {
            text: "ซ่อมเสร็จแล้ว รอการจัดส่ง",
            color: "success",
            icon: "bi-truck",
        },
        11111: {
            text: "ยกเลิกคำสั่งซ่อม",
            color: "danger",
            icon: "bi-x-circle",
        },
        22222: {
            text: "อยู่ระหว่างรออะไหล่",
            color: "secondary",
    ...
    return (
        <BootstrapLayout>
            ...
            <div className="container py-5">
                ...
                >
                    <div className="mb-3">
                        <label htmlFor="repairId" className="form-label">
                            หมายเลขใบซ่อม
                        </label>
                        <input
                            id="repairId"
                    ...
                    <div className="mt-4">
                        {status && (
                            <div
                                className={`alert alert-${status.color} d-flex align-items-center`}
                                role="alert"
                            >
